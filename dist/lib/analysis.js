...
function analyse(positions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let position of positions.slice(1)) {
                                ...
                                try {
                                    ...
                                    for (let row of captureTestBoard.board()) {
                                        for (let enemyPiece of row) {
                                            if (!enemyPiece)
                                                continue;
                                            if (enemyPiece.color == captureTestBoard.turn() || enemyPiece.type == "k")
                                                continue;
            ...
            if (position.classification == classification_1.Classification.BLUNDER && previousAbsoluteEvaluation <= -600) {
                position.classification = classification_1.Classification.GOOD;
            }
